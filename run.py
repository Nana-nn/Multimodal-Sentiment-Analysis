...
def main():
    ...
    parser.add_argument("--data_dir", default='./实验五数据', type=str, help="directory that contains processed data.")
    ...
    parser.add_argument('--path_image', default="./实验五数据/data/", help='图像的存放路径')
